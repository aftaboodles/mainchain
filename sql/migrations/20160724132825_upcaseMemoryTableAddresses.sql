...
UPDATE "mem_accounts2rankings" SET "accountId" = UPPER("accountId") WHERE "accountId" LIKE '%l';

UPDATE "mem_accounts2u_rankings" SET "accountId" = UPPER("accountId") WHERE "accountId" LIKE '%l';
...
UPDATE "mem_accounts2ac_status" SET "accountId" = UPPER("accountId") WHERE "accountId" LIKE '%l';

UPDATE "mem_accounts2u_ac_status" SET "accountId" = UPPER("accountId") WHERE "accountId" LIKE '%l';
